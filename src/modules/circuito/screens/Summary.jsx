...
export default function Summary({ state, reset, goTo, saveEvaluation, savedEvaluations }) {
  const { studentData, checkedItems, observations, vistoConfirmado, vistoNomeConfirmacao, vistoDataHora, customError } = state
    ...
    <div className="screen-container">
      <header className="header no-print">
        ...
        <div className="header-titles">
          ...
          <span className="header-subtitle">Resumo Final – Circuito Operacional – CFSD 2026</span>
        </div>
