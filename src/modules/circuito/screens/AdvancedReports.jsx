...
export default function AdvancedReports({
  ...
  const exportToCSV = () => {
    ...
    link.setAttribute('download', `relatorio_avancado_circuito_${new Date().toISOString().split('T')[0]}.csv`)
  ...
  const exportToExcel = () => {
    ...
    XLSX.utils.book_append_sheet(wb, ws, 'Relatório Circuito')
    ...
    XLSX.writeFile(wb, `relatorio_avancado_circuito_${new Date().toISOString().split('T')[0]}.xlsx`)
  }
    ...
    <div className="screen-container">
      <header className="header no-print">
        ...
        <div className="header-titles">
          ...
          <span className="header-subtitle">Circuito Operacional • CFSD 2026</span>
        </div>
                ...
                >
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 8 }}>
                    ...
                    <div style={{ fontSize: 11, fontWeight: 700, color: 'var(--gold)' }}>
                      {pelotao.atOrAboveRate}%
                    </div>
                  </div>
                  <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: 11, color: 'var(--text-secondary)' }}>
                    <span>{pelotao.atOrAbove}/{pelotao.total} ≥ média</span>
